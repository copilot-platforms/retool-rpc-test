...
async function pollingTimeout() {
    await setTimeout(POLLING_TIMEOUT_MS);
...
class RetoolSDK {
    ...
    async _registerAgent() {
        ...
        const response = await fetch(`${this._hostUrl}/api/v1/retoolsdk/registerAgent`, {
            method: 'POST',
            // TODO: add ApiToken
            headers: {
    ...
    async _fetchQueryAndExecute() {
        const pendingQueryFetch = await fetch(`${this._hostUrl}/api/v1/retoolsdk/popQuery`, {
            method: 'POST',
            headers: {
                Authorization: `Bearer ${this._apiKey}`,
                'Content-Type': 'application/json',
        ...
        if (body.query) {
            ...
            const updateQueryResponse = await fetch(`${this._hostUrl}/api/v1/retoolsdk/postQueryResponse`, {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${this._apiKey}`,
                    'Content-Type': 'application/json',
...
export { RetoolSDK, RetoolSDKVersion };
