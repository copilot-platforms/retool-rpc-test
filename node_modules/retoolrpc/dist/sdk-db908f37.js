...
class RetoolAPI {
    ...
    async popQuery(options) {
        return fetch(`${this._hostUrl}/api/v1/retoolsdk/popQuery`, {
            method: 'POST',
            headers: {
    ...
    async registerAgent(options) {
        return fetch(`${this._hostUrl}/api/v1/retoolsdk/registerAgent`, {
            method: 'POST',
            // TODO: Add ApiToken
            headers: {
                Authorization: `Bearer ${this._apiKey}`,
    ...
    async postQueryResponse(options) {
        return fetch(`${this._hostUrl}/api/v1/retoolsdk/postQueryResponse`, {
            method: 'POST',
            // TODO: add ApiToken
            headers: {
                Authorization: `Bearer ${this._apiKey}`,
